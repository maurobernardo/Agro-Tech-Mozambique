...
export const metadata: Metadata = {
  ...
  description:
    "Missão, visão e valores da AGRO TECH MOZAMBIQUE. Empresa moçambicana em Nampula desde 2025. Comércio agrícola, consultoria e apoio ao sector agroindustrial.",
  openGraph: {
    title: "Sobre Nós | AGRO TECH MOZAMBIQUE",
    description:
